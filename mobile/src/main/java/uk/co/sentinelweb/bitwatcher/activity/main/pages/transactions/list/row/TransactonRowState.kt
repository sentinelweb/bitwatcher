...
data class TransactonRowState constructor(var transaction: TransactionItemDomain? = null) {
    ...
    sealed class DisplayModel constructor(open val id: String,open val amount: String, open val date: String, open val accountName: String) {
        ...
        ) : DisplayModel(id, amount, date, accountName)
